...
const OwnerCoFounder: React.FC = () => {
    ...
    return (
        <section id="about" className={`${styles.flexCenter} ${styles.marginY} ${styles.paddingOwner} sm:flex-row flex-col bg-black-gradient-2 rounded-[20px] box-shadow relative overflow-hidden`} style={{marginTop: '60px'}}>
            ...
            <div className="slant-divider social-mentor-animation" style={{ height: '20px', width: '5%', background: 'transparent', position: 'relative' }}>
                ...
                <a href="https://www.instagram.com/tharun_socialmentor/" target="_blank" rel="noopener noreferrer">
                    <div 
                        className={`${styles} py-1 px-1 bg-blue-gradient font-poppins font-medium text-[18px] text-primary outline-none rounded-[50%] transition-transform duration-300 ease-linear cursor-pointer hover:scale-105`} // CSS hover effect
                    >
                        <img 
                            ref={imageRef} 
                            src="/assets/SocialMentorImage.jpg" 
                            alt="Social Mentor Instagram" 
                            className={`owner-image rounded-[50%] ${isVisible ? 'flip' : ''} w-full h-auto`} 
                        />              
                    </div>
                </a>
                <div className={`${styles.paragraph} max-w-[470px] mt-5 owner-list`}>
                    <div className='owner-list-item flex flex-col items-center'>
                        <span className='owner-name text-lg font-bold'>Tharun Kumar K</span>
                        <span className='owner-name text-sm'>(Founder)</span>
                        <span className='owner-name ml-1 text-sm font-medium text-[#33bbcf] mt-1'>@tharun_socialmentor</span>
                    </div>
                    <div className="owner-list-item flex items-center justify-center text-blue-500">
                        <Image src={insta_1} alt="Instagram Icon" className="w-8 h-8" />
            ...
            <div className={`${styles.flexCenter} flex-col sm:ml-10 ml-0 sm:mt-0 mt-10 relative z-10`}>
                <a href="https://www.instagram.com/digital_sathiya94/" target="_blank" rel="noopener noreferrer">
                    <div 
                        className={`${styles} py-1 px-1 bg-blue-gradient font-poppins font-medium text-[18px] text-primary outline-none rounded-[50%] transition-transform duration-300 ease-linear cursor-pointer hover:scale-105`} // CSS hover effect
                    >
                        <img 
                ...
                <div className={`${styles.paragraph} max-w-[470px] mt-5 owner-list`}>
                    <div className='owner-list-item flex flex-col items-center'>
                        <span className='owner-name text-lg font-bold'>Sathiya Lakshmi</span>
                        <span className='owner-name text-sm'>(Co-Founder)</span>
                        <span className='owner-name mt-1 text-sm font-medium text-[#33bbcf] mt-1'>@digital_sathiya94</span>
                    </div>
                    <div className="owner-list-item flex items-center justify-center text-blue-500">
                        <Image src={insta_1} alt="Instagram Icon" className="w-8 h-8" />
                        <span className="text-white">50K Followers</span>
                    </div>
